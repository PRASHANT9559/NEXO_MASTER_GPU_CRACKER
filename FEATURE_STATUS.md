...
- Features added by my recent commits in this thread: **3**
...
| 4 | Fix SHA-256 Multi-Block | ⚠️ Partial/uncertain | Multi-block logic exists but not fully validated by tests in this environment. |
| 5 | Chunked Dictionary Loading | ❌ Not added | Current implementation loads the full wordlist into memory at once. |
